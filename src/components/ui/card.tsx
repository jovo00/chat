...
function CardHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("@container/card-header flex flex-col justify-center px-6 py-5 border-b", className)}
      {...props}
    />
  );
}
...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return <div data-slot="card-title" className={cn("leading-none font-special text-2xl", className)} {...props} />;
}
