...
export default function Sidebar({
  ...
  return (
    <>
      <div
        className={cn(
          "absolute top-0 left-0 z-40 h-full w-full bg-black/40 transition-all",
          !mobileMenuOpen && "pointer-events-none bg-transparent",
        )}
        ...
        {isDesktop && (
          ...
          >
            <Link
              href="/"
              className={cn(
                "mb-8 flex w-10 justify-center transition-[margin-bottom] duration-300",
                collapsed && "mb-6",
              )}
            >
              {isDesktop && (
